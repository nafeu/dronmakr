...
from dronmakr.audio.process_sample import trim_sample_start, trim_sample_end, reverse_sample
...
def register_folysplitr(app):
    ...
    @app.route("/api/folysplitr/trash/count", methods=["GET"])
    def api_folysplitr_trash_count():
        ensure_splits_dirs()
        trash_dir = SPLITS_DIR / "trash"
